...
/***/ (function(module, exports, __webpack_require__) {
	...
	var courseEvents = __webpack_require__(13);

	$(function () {
	  authEvents.addHandlers();
	  authEvents.setUpApp();
	  courseEvents.addHandlers();
	});
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://secret-garden-31573.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getFormFields = __webpack_require__(9);
	var courseStore = __webpack_require__(14);
	var api = __webpack_require__(15);
	var ui = __webpack_require__(16);

	var onIndexCourses = function onIndexCourses() {
	  // console.log('onIndexCourse from Events.js Ran')
	  event.preventDefault();
	  api.indexCourses().then(ui.indexCourseSuccess).then(function () {
	  ...
	  }).catch(ui.actionFailure).then(function () {
	    $('.saveButton, .cancelButton').hide();
	...
	var rerunIndex = function rerunIndex() {
	...
	var onDestroyCourse = function onDestroyCourse(event) {
	  event.preventDefault();
	  var id = $(this).attr('data-id');
	  // console.log(id)
	  api.destroyCourse(id).then(ui.destroyCourseSuccess).catch(ui.actionFailure).then(rerunIndex);
	  courseStore.id = null;
	};

	var onCreateCourse = function onCreateCourse(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  api.createCourse(data).then(ui.createCourseSuccess).catch(ui.actionFailure).then(rerunIndex);
	...
	var onEditCourse = function onEditCourse(event) {
	...
	var onSaveCourse = function onSaveCourse(event) {
	  var courseTitle = $(this).parent().parent().find('td.C1')[0].innerHTML;
	  var courseSemester = $(this).parent().parent().find('td.C2')[0].innerHTML;
	  var courseGrade = $(this).parent().parent().find('td.C3')[0].innerHTML;
	  var courseCredits = $(this).parent().parent().find('td.C4')[0].innerHTML;
	  var strippedTitle = courseTitle.replace(/(<([^>]+)>)/ig, '');
	  var strippedSemester = courseSemester.replace(/(<([^>]+)>)/ig, '');
	  var strippedGrade = courseGrade.replace(/(<([^>]+)>)/ig, '');
	  var strippedCredits = courseCredits.replace(/(<([^>]+)>)/ig, '');
	  ...
	  api.updateCourse(data, id).then(ui.updateCourseSuccess).catch(ui.updateCourseFailure).then(function () {
	...
	var onCancelCourse = function onCancelCourse(event) {
	  var id = $(this).attr('data-id');
	  $($('tr[data-id=' + id + ']').children()[0]).attr('contenteditable', 'false');
	  $($('tr[data-id=' + id + ']').children()[1]).attr('contenteditable', 'false');
	  $($('tr[data-id=' + id + ']').children()[2]).attr('contenteditable', 'false');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var indexCourses = function indexCourses() {
	  return $.ajax({
	...
	var showCourse = function showCourse(id) {
	  return $.ajax({
	...
	var updateCourse = function updateCourse(data, id) {
	  return $.ajax({
	    url: config.apiOrigin + '/courses/' + id,
	    method: 'PATCH',
	    headers: {
	...
	var destroyCourse = function destroyCourse(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/courses/' + id,
	    method: 'DELETE',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var indexCoursesTemplate = __webpack_require__(17);
	var api = __webpack_require__(15);
	var courseStore = __webpack_require__(14);
	var courseEvents = __webpack_require__(13);

	var actionFailure = function actionFailure(error) {
	  console.error(error);
	};

	var createCourseSuccess = function createCourseSuccess(data) {
	  // console.log('Successfully created Course.')
	  // console.log('Data is: ', data)
	};

	var indexCourseSuccess = function indexCourseSuccess(data) {
	  if (data.courses.length < 1) {
	    var indexCoursesHtml = indexCoursesTemplate({ courses: data.courses });
	    $('#handlebars-content').html(indexCoursesHtml);
	    $('#no-courses').show();
	  } else {
	    var _indexCoursesHtml = indexCoursesTemplate({ courses: data.courses });
	    $('#handlebars-content').html(_indexCoursesHtml);
	    $('#no-courses').hide();
	  }
	...
	var destroyCourseSuccess = function destroyCourseSuccess() {
	  // console.log('Successfully destroyed Course.')
	  $('.credit-fail').hide();
	};

	var updateCourseSuccess = function updateCourseSuccess() {
	  $('.credit-success').fadeIn();
	  $('.credit-success').fadeOut(8000);
	  $('.credit-fail').hide();
	};

	var updateCourseFailure = function updateCourseFailure() {
	  $('.credit-fail').fadeIn();
	...
	module.exports = {
	  ...
	  indexCourseSuccess: indexCourseSuccess,
	  destroyCourseSuccess: destroyCourseSuccess,
	  updateCourseSuccess: updateCourseSuccess,
	  updateCourseFailure: updateCourseFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "      <tr data-id=\""
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.semester : stack1), depth0))
	    + "</td>\n        <td class=\"C3\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"number\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.credits : stack1), depth0))
	    + "</td>\n        <td class=\"C5\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n          <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn-md btn-primary form-control editButton\" type=\"button\">Edit</button>\n          <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn-md btn-warning form-control saveButton\" type=\"button\">Save</button>\n        </td>\n        <td class=\"C6\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n          <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn-md btn-danger form-control destroyButton\" type=\"button\">Delete</button>\n          <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn-md btn-default form-control cancelButton\" type=\"button\">Cancel</button>\n        </td>\n      </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

	  return "<div class=\"hbs-narrative\">\n  <h2>Grade Trackr &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; Course History</h2>\n  <br>\n  <h5>Below is your list of logged courses, grades, and credits.</h5>\n</div>\n<br>\n\n<div id=\"course-table\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.course : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <table data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.course : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"table table-hover\">\n    <thead> \n      <tr>\n        <th id=largeCol>Course</th>\n        <th id=mediumCol>Semester</th>\n        <th id=smallCol>Grade</th>\n        <th id=smallCol>Credits</th>\n        <th id=actionCol></th>\n        <th id=actionCol></th>\n      </tr>\n    </thead> \n    <tbody data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.course : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\"> \n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.courses : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    </tbody> \n  </table>\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "ec61ea2a71d4f8bc4e7eff74b1c0cb86.jpg";

/***/ }),
/* 46 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "935d678b59bfdfdf735eb5434c50ce8c.jpg";
